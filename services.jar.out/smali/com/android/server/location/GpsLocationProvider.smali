...
.field private static final ALARM_DELAY_TIMEOUT:Ljava/lang/String; = "com.android.internal.location.ALARM_DELAY_TIMEOUT"
...
.field private static final XTRA_DOWNLOAD_RETRY_MAX_TIMES:I = 0x3
...
.field private final mDelayTimeoutIntent:Landroid/app/PendingIntent;
...
.field private mXtraDownloadRetryTimes:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;Landroid/os/Looper;)V
    ...
    const-string v11, "com.android.internal.location.ALARM_DELAY_TIMEOUT"
    ...
    iput-object v8, p0, Lcom/android/server/location/GpsLocationProvider;->mDelayTimeoutIntent:Landroid/app/PendingIntent;
...
.method static synthetic access$1600(Lcom/android/server/location/GpsLocationProvider;)I
    ...
    .prologue
    .line 92
    iget v0, p0, Lcom/android/server/location/GpsLocationProvider;->mXtraDownloadRetryTimes:I

    return v0
.end method

.method static synthetic access$1602(Lcom/android/server/location/GpsLocationProvider;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 92
    iput p1, p0, Lcom/android/server/location/GpsLocationProvider;->mXtraDownloadRetryTimes:I

    return p1
.end method

.method static synthetic access$1608(Lcom/android/server/location/GpsLocationProvider;)I
    .locals 2
    .parameter "x0"
    ...
    iput v1, p0, Lcom/android/server/location/GpsLocationProvider;->mXtraDownloadRetryTimes:I
...
.method static synthetic access$3300(Lcom/android/server/location/GpsLocationProvider;Landroid/os/Bundle;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private delayDownloadXtra(Landroid/os/Bundle;)Z
    .locals 8
    .parameter "extras"
    ...
    const-string v4, "autoDownloadXtra,extras==NULL"
    ...
    const-string v5, "delayDownloadXtra,delay="
    ...
    iget-object v6, p0, Lcom/android/server/location/GpsLocationProvider;->mDelayTimeoutIntent:Landroid/app/PendingIntent;
...
.method private delayDownloadXtra_Cancel()Z
    .locals 2
    ...
    iget-object v1, p0, Lcom/android/server/location/GpsLocationProvider;->mDelayTimeoutIntent:Landroid/app/PendingIntent;
...
.method private handleDownloadXtraData()V
    ...
    const-string v1, "android.location.GPS_XTRA_DOWNLOADED"
    ...
    new-instance v2, Lcom/android/server/location/GpsLocationProvider$5;

    invoke-direct {v2, p0}, Lcom/android/server/location/GpsLocationProvider$5;-><init>(Lcom/android/server/location/GpsLocationProvider;)V
...
.method private handleEnable()V
    ...
    .line 948
    .local v4, strSuplServerHost:Ljava/lang/String;
    ...
    .line 955
    .local v5, strSuplServerPort:Ljava/lang/String;
    ...
    const-string v6, "android.location.GPS_XTRA_INTERFACE_INITIALIZED"
    ...
    const-string v8, "handleEnable NumberFormatException for:"
...
.method private listenForBroadcasts()V
    ...
    .line 609
    const-string v2, "com.android.internal.location.ALARM_DELAY_TIMEOUT"
...
.method public sendExtraCommand(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    .line 1181
    :cond_4
    const-string v3, "force_delay_donwload_xtra"
    ...
    .line 1183
    invoke-direct {p0, p2}, Lcom/android/server/location/GpsLocationProvider;->delayDownloadXtra(Landroid/os/Bundle;)Z
    ...
    .line 1185
    :cond_5
    const-string v3, "force_delay_donwload_xtra_cancel"
    ...
    .line 1186
    invoke-direct {p0}, Lcom/android/server/location/GpsLocationProvider;->delayDownloadXtra_Cancel()Z
