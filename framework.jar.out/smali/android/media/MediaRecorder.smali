...
.method public setAudioSource(I)V
    ...
    invoke-interface {v2, v3, v4}, Landroid/seccap/ITYSecCapManager;->getPkgName(ILjava/lang/String;)Ljava/lang/String;
    :try_end_0
    ...
    invoke-interface {v2, v1, v3, v4, v5}, Landroid/seccap/ITYSecCapManager;->checkPermissionSync(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    const-string v4, "MediaRecorder checkAudioPer checkPermissionSync RemoteException"
    ...
    .end local v1           #packageName:Ljava/lang/String;
    .end local v2           #service:Landroid/seccap/ITYSecCapManager;
    :cond_0
    ...
    .restart local v2       #service:Landroid/seccap/ITYSecCapManager;
    :catch_1
    move-exception v0
    ...
    const-string v4, "MediaRecorder service.getPkgName RemoteException"
...
.method public setVideoSource(I)V
    ...
    invoke-interface {v2, v4, v5}, Landroid/seccap/ITYSecCapManager;->getPkgName(ILjava/lang/String;)Ljava/lang/String;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    :try_start_1
    invoke-interface {v2, v4}, Landroid/seccap/ITYSecCapManager;->getActstring(I)Ljava/lang/String;
    ...
    invoke-interface {v2, v1, v4, v3, v5}, Landroid/seccap/ITYSecCapManager;->checkPermissionSync(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    const-string v5, "MediaRecorder checkVideoPer checkPermissionSync RemoteException"
    ...
    const-string v5, "MediaRecorder service.getPkgName RemoteException"
